...
<body>
	...
	$sql = 'INSERT INTO tab_parceiros (nome, cnpj, endereco, telefone, email, responsavel, cargo, celular, emailcontato, status, foto)
		VALUES(:nome, :cnpj, :endereco, :telefone, :email, :responsavel, :cargo, :celular, :emailcontato, :status, :foto)';
			...
			echo "<meta http-equiv=refresh content='3;URL=cadastro_parceiro.php'>";
		...
		if ($acao == 'editar'):
			...
			$sql = 'UPDATE tab_parceiros SET nome=:nome, email=:email, cnpj=:cnpj, endereco=:endereco, telefone=:telefone, email=:email, responsavel=:responsavel, cargo=:cargo, celular=:celular, emailcontato=:emailcontato, status=:status, foto=:foto WHERE id = :id';
