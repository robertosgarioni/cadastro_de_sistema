...
<article class="container">
		<hr>			
		<a href='termo.php' class="btn btn-danger">Cadastrar os Termos</a>
		...
		<div class='clearfix'></div>
			...
			<?php if(!empty($geral)):?>
				<table class="table table-striped">
					...
					<?php foreach($geral as $geral):?>
						<tr>
							<td><img src='fotos/<?=$geral->foto?>' height='40' width='40'></td>
			...
			<?php else: ?>
				...
				<h3 class="text-center text-primary">Não existem Termos cadastrados!</h3>
			<?php endif; ?>
		</fieldset>
	</div>
